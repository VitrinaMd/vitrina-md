...
def main_menu(user_id):
    ...
    keyboard.add(
        types.KeyboardButton(tr(user_id, "order")),
        types.KeyboardButton(tr(user_id, "service"))
    )
...
def admin_callback(call):
    ...
    action, listing_id_text = call.data.split(
        ":",
        1
    )
